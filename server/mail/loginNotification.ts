...
export async function sendLoginNotification(email: string, username: string) {
    try {
        ...
        const mailOptions = {
            ...
            to: email,
            subject: `Hi ${username} new sign in detected`,
    ...
    <div style="text-align: center;">
      ...
      <div style="font-size: 18px; margin-bottom: 10px;">Hi ${username}! a new sign in detected for your account. If you don't know about this, then your account may be at risk. Change your password immediatly.</div>
              <a href="https://auth-iskips-projects.vercel.app" style="text-decoration:none;background-color: #181818; color: ghostwhite; font-weight: 500; font-size: 24px; padding: 8px 20px; border-radius: 20px; display: inline-block; margin-bottom: 20px;">Change Password</a>
    </div>
